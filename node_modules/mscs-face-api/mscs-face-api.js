...
function MSCSFaceApi(key, server) {
    ...
    function detectFace(image) {
        return new Promise((resolve, reject) => {
            axios({
				...
				console.log(res.data);
				config.faceDetection.faceIds[0] = faceIds;
				
				console.log('config.faceDetection.faceIds[0] 에 들어간 아이디 값 '+config.faceDetection.faceIds[0]);
				config.faceDetection.emotion.anger =  res.data[0].faceAttributes.emotion.anger;
				config.faceDetection.emotion.contempt =  res.data[0].faceAttributes.emotion.contempt;
				config.faceDetection.emotion.disgust =  res.data[0].faceAttributes.emotion.disgust;
				config.faceDetection.emotion.fear =  res.data[0].faceAttributes.emotion.fear;
				config.faceDetection.emotion.happiness =  res.data[0].faceAttributes.emotion.happiness;
				config.faceDetection.emotion.neutral =  res.data[0].faceAttributes.emotion.neutral;
				config.faceDetection.emotion.sadness =  res.data[0].faceAttributes.emotion.sadness;
				config.faceDetection.emotion.surprise =  res.data[0].faceAttributes.emotion.surprise;
				console.log(config.faceDetection);
    ...
    function identifyFace(personGroupId,  confidenceThreshold) {
		var faceIds = config.faceDetection.faceIds;
		console.log(config.faceDetection.faceIds+"을 비교합니다");
        ...
        return new Promise((resolve, reject) => {
            Promise.all(all)
                .then((res) => {
					...
					config.faceDetection.confidence = identify[0].candidates[0].confidence;
		
					global.personId = identify[0].candidates[0].personId;
					
					if(config.faceDetection.confidence>0.5){
						$scope.face = "얼굴인식 완료";
